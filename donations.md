...
**Please Note::**
These are __donations__ - any donations go towards the upkeep of the server and any costs for future changes/additions etc... 
As such refunds are **not applicable** at any time. Please be 100% sure that you can afford to and that you have permission to if it is with somebody elses money before you donate!
...
- Have access to use `/se`, which allows you to change the text on a sign without needing to break and replace it (eg `/se 1 &4Hello` to set the top line of the sign you are looking at to Hello in red!)
- Ability to have up to 25 items in the Auction House.
- This will also unlock the Donator Trophy in your `/case` on the server!
